...
//        
//        // Add a user first
//        let user = addUser(context: context, firstName: "John", lastName: "Doe")
//        
//        let viewModel = AddExerciseViewModel(context: context)
//        viewModel.category = .football
//        viewModel.duration = 60
//        viewModel.intensity = 4
//        
//        // Associate the user with the exercise
//        try! context.performAndWait {
//            let newExercise = Exercise(context: context)
//            newExercise.category = viewModel.category.rawValue
//            newExercise.duration = Int64(viewModel.duration)
...
//    }
//    
//    private func addUser(context: NSManagedObjectContext, firstName: String, lastName: String) -> User {
//        let newUser = User(context: context)
//        newUser.firstName = firstName
//        newUser.lastName = lastName
//        try! context.save()
